...
!function() {
    ...
    function o(t, e, n) {
        ...
        s("leftward is properly set up", function() {
    ...
    function c(e) {
        function n(t) {
            var e, n;
            return t && t.nodeType ? (e = _t(t).children(".mq-root-block").attr(xt),
            n = e && St.byId[e].controller,
            n ? s[n.KIND_OF_MQ](n) : null) : null
        }
        function i(t, e) {
            var n, i, r;
        ...
        var s, r, o;
        if (!(e >= g && b >= e))
            throw "Only interface versions between " + g + " and " + b + " supported. You specified: " + e;
        s = {},
        n.L = Tt,
        n.R = Ct,
        n.config = function(t) {
        ...
        r = s.AbstractMathQuill = Qt($t, function(t) {
            ...
            t.__mathquillify = function(t) {
                var e, n = this.__controller, i = n.root, s = n.container;
                n.createTextarea(),
                e = s.addClass(t).contents().detach(),
                i.jQ = _t('<span class="mq-root-block"/>').attr(xt, i.id).appendTo(s),
                this.latex(e.text()),
        ...
        s.EditableField = Qt(r, function(e, n) {
            ...
            ,
            e.cmd = function(t) {
                var e, n = this.__controller.notify(), i = n.cursor;
            ...
            e.dropEmbedded = function(t, e, n) {
                var i, s = t - _t(window).scrollLeft(), r = e - _t(window).scrollTop(), o = document.elementFromPoint(s, r);
                this.__controller.seek(_t(o), t, e),
                i = mt().setOptions(n),
            ...
            e.clickAt = function(t, e, n) {
                ...
                var i = this.__controller
                  , s = i.root;
                return wt.contains(s.jQ[0], n) || (n = s.jQ[0]),
                i.seek(_t(n), t + pageXOffset, e + pageYOffset),
        ...
        for (o in Mt)
            (function(t, i) {
                ...
                n[t] = function(i, s) {
                    var o, a = n(i);
                    return a instanceof r || !i || !i.nodeType ? a : (o = zt(r.RootBlock(), _t(i), Bt()),
                    o.KIND_OF_MQ = t,
    ...
    function p(t, e) {
        ...
        t.reflow = function() {
            ...
            K(this.delimjQs, yt(1 + .2 * (t - 1), 1.2), 1.2 * t)
        }
    }
    function d(t, e) {
        var e = e || t
          , n = ft[t]
          , s = ft[e];
        At[t] = i(ht, Tt, t, n, e, s),
        At[n] = i(ht, Ct, t, n, e, s)
    }
    var m, g, b, v, w, q, x, y, O, k, j, Q, T, C, _, D, S, L, E, A, R, I, z, M, B, F, $, N, P, U, W, H, G, K, Y, X, Z, V, J, tt, et, nt, it, st, rt, ot, at, lt, ct, ut, ht, ft, pt, dt, mt, gt, bt, vt, wt = window.jQuery, qt = "mathquill-command-id", xt = "mathquill-block-id", yt = Math.min, Ot = Math.max, kt = [].slice, jt = e(function(t, n) {
        ...
        return function o(a, l) {
            ...
            (c.open = function(t) {
                if (p = {},
                s(t) ? p = t.call(c, f, h, c, a) : i(t) && (p = t),
                i(p))
                    for (var n in p)
                        e.call(p, n) && (f[n] = p[n]);
                return s(f.init) || (f.init = a),
                c
            }
            )(l)
        }
    }("prototype", {}.hasOwnProperty), Tt = -1, Ct = 1, _t = Qt(wt, function(t) {
        ...
        t.jQize = function(t) {
            function e(t) {
                var n, i;
                for (t.getAttribute && (n = t.getAttribute("mathquill-command-id"),
        ...
        t.createDir = function(t, e) {
            ...
            e[t] = n.adopt(e.parent, e[Tt], e[Ct]),
            n
        }
        ,
        ...
        t.withDirAdopt = function(t, e, n, i) {
            return Lt(this, this).withDirAdopt(t, e, n, i),
            this
        }
        ,
        t.adopt = function(t, e, n) {
            return Lt(this, this).adopt(t, e, n),
            this
        }
        ,
        t.disown = function() {
            return Lt(this, this).disown(),
            this
        }
        ,
        t.remove = function() {
        ...
        t.init = function(t, e, n) {
            ...
            this.ends = {},
            t) {
                s("withDir is passed to Fragment", t instanceof St),
                s("oppDir is passed to Fragment", e instanceof St),
                s("withDir and oppDir have the same parent", t.parent === e.parent),
                this.ends[n] = t,
                this.ends[-n] = e;
        ...
        t.adopt = function(t, e, n) {
            ...
            i = this,
            i.disowned = !1,
            (s = i.ends[Tt]) ? (r = i.ends[Ct],
            e || (t.ends[Tt] = s),
            n ? n[Tt] = r : t.ends[Ct] = r,
            i.ends[Ct][Ct] = n,
            i.each(function(n) {
                n[Tt] = e,
                n.parent = t,
        ...
        ,
        t.disown = function() {
            var t, e, n = this, i = n.ends[Tt];
            return !i || n.disowned ? n : (n.disowned = !0,
            t = n.ends[Ct],
            e = i.parent,
            o(e, i[Tt], i),
            o(e, t, t[Ct]),
            i[Tt] ? i[Tt][Ct] = t[Ct] : e.ends[Tt] = t[Ct],
            t[Ct] ? t[Ct][Tt] = i[Tt] : e.ends[Ct] = i[Tt],
            n)
        }
        ,
        t.remove = function() {
        ...
        ,
        t.each = n(function(t) {
            var e, n = this, i = n.ends[Tt];
            if (!i)
                return n;
            for (; i !== n.ends[Ct][Ct] && (e = t(i),
            e !== !1); i = i[Ct])
                ;
            return n
        }),
        ...
        t.show = function() {
            ...
            "intervalId"in this ? clearInterval(this.intervalId) : (this[Ct] ? this.selection && this.selection.ends[Tt][Tt] === this[Tt] ? this.jQ.insertBefore(this.selection.jQ) : this.jQ.insertBefore(this[Ct].jQ.first()) : this.jQ.appendTo(this.parent.jQ),
            this.parent.focus()),
        ...
        t.jumpUpDown = function(t, e) {
            var n, i, s = this;
            s.upDownCache[t.id] = Dt.copy(s),
            n = s.upDownCache[e.id],
            n ? n[Ct] ? s.insLeftOf(n[Ct]) : s.insAtRightEnd(n.parent) : (i = s.offset().left,
            e.seek(i, s))
        }
        ,
        t.offset = function() {
            ...
            return t.jQ.addClass("mq-cursor"),
            e
        }
        ,
        t.unwrapGramp = function() {
            ...
            this[Ct] ? this.insLeftOf(this[Ct]) : this.insAtRightEnd(e),
            t.jQ.remove(),
            t[Tt].siblingDeleted && t[Tt].siblingDeleted(i.options, Ct),
            t[Ct].siblingDeleted && t[Ct].siblingDeleted(i.options, Tt)
        }
        ,
        t.startSelection = function() {
            var t, e = this.anticursor = Dt.copy(this), n = e.ancestors = {};
        ...
        t.select = function() {
            ...
            if (this[Tt] === l[Tt] && this.parent === l.parent)
                return !1;
            ...
            if (s("cursor and anticursor in the same tree", e),
            n = l.ancestors[e.id],
            o = Ct,
            t[Tt] !== n)
                for (a = t; a; a = a[Ct])
            ...
            return o === Ct && (i = n,
            r = t),
            i instanceof Dt && (i = i[Ct]),
            r instanceof Dt && (r = r[Tt]),
        ...
        t.deleteSelection = function() {
            this.selection && (this[Tt] = this.selection.ends[Tt][Tt],
            this[Ct] = this.selection.ends[Ct][Ct],
        ...
        t.replaceSelection = function() {
            ...
            return t && (this[Tt] = t.ends[Tt][Tt],
            this[Ct] = t.ends[Ct][Ct],
            delete this.selection),
            t
        }
        ...
        t.init = function(t, e, n) {
            ...
            this.options = n,
            t.controller = this,
            this.cursor = t.cursor = Rt(t, n)
        }
        ,
        t.handle = function(t, e) {
            var n, i = this.options.handlers;
            i && i.fns[t] && (n = i.APIClasses[this.KIND_OF_MQ](this),
            e === Tt || e === Ct ? i.fns[t](e, n) : i.fns[t](n))
        }
        ;
        var e = [];
    ...
    w = Qt(function(t, e, n) {
        ...
        t.then = function(t) {
            ...
            return n(function(i, r, o) {
                function a(e, i) {
                    ...
                    return s("a parser is returned", a instanceof n),
                    a._(e, r, o)
                }
                return e._(i, a, o)
            })
        ...
        f = n.digits = o(/^[0-9]*/),
        p = n.whitespace = o(/^\s+/),
        d = n.optWhitespace = o(/^\s*/),
        m = n.any = n(function(t, e, n) {
    ...
    q = function() {
        function e(t) {
            var e, i = t.which || t.keyCode, s = n[i], r = [];
        ...
        return function(n, i) {
            ...
            function l(e) {
                ...
                b = null,
                m && s(function(e) {
                    e && "focusout" === e.type || !v[0].select || v[0].select(),
                    q = t,
                    clearTimeout(d)
                }),
                a()
            ...
            function u() {
                if (!o()) {
                    var t = v.val();
                    1 === t.length ? (v.val(""),
                    i.typedText(t)) : t && v[0].select && v[0].select()
                }
            }
            function h() {
                g = b = null
            ...
            var d, m, g = null, b = null, v = wt(n), w = wt(i.container || v), q = t;
    ...
    zt.open(function(t) {
        t.focusBlurEvents = function() {
            ...
            function e() {
                ...
                _t(window).off("blur", t)
            }
            var n, i = this, s = i.root, r = i.cursor;
            i.textarea.focus(function() {
                i.blurred = !1,
                clearTimeout(n),
                i.container.addClass("mq-focused"),
                r.parent || r.insAtRightEnd(s),
                r.selection ? (r.selection.jQ.removeClass("mq-blur"),
                i.selectionChanged()) : r.show()
            }).blur(function() {
                i.blurred = !0,
    ...
    zt.open(function(t) {
        function e(t, e) {
            ...
            return n[Ct][i] ? n.insAtLeftEnd(n[Ct][i]) : n[Tt][i] ? n.insAtRightEnd(n[Tt][i]) : n.parent.bubble(function(t) {
                var e = t[s];
                return e && ("function" == typeof e && (e = t[s](n)),
                e instanceof St && n.jumpUpDown(t, e),
                e !== !0) ? !1 : void 0
            }),
            t
        }
        ...
        t.escapeDir = function(t, e, n) {
            r(t);
            var i = this.cursor;
            return i.parent !== this.root && n.preventDefault(),
            i.parent !== this.root ? (i.parent.moveOutOf(t, i),
            this.notify("move")) : void 0
        }
        ,
        ...
        t.deleteDir = function(t) {
            ...
            e[Tt].siblingDeleted && e[Tt].siblingDeleted(e.options, Ct),
            e[Ct].siblingDeleted && e[Ct].siblingDeleted(e.options, Tt),
        ...
        t.ctrlDeleteDir = function(t) {
            r(t);
            var e = this.cursor;
            return !e[Tt] || e.selection ? ctrlr.deleteDir() : (this.notify("edit"),
            Lt(e.parent.ends[Tt], e[Tt]).remove(),
            e.insAtDirEnd(Tt, e.parent),
            e[Tt].siblingDeleted && e[Tt].siblingDeleted(e.options, Ct),
            e[Ct].siblingDeleted && e[Ct].siblingDeleted(e.options, Tt),
            e.parent.bubble("reflow"),
            this)
        ...
        t.selectDir = function(t) {
            var e, n = this.notify("select").cursor, i = n.selection;
            r(t),
            n.anticursor || n.startSelection(),
            e = n[t],
            e ? i && i.ends[t] === e && n.anticursor[-t] !== e ? e.unselectInto(t, n) : e.selectTowards(t, n) : n.parent.selectOutOf(t, n),
            n.clearSelection(),
            n.select() || n.show()
        }
        ,
    ...
    zt.open(function(t, e) {
        ...
        t.writeLatex = function(t) {
            var e, n = this.notify("edit").cursor, i = w.all, s = w.eof, r = x.skip(s).or(i.result(!1)).parse(t);
            return r && !r.isEmpty() && (r.children().adopt(n.parent, n[Tt], n[Ct]),
            e = r.jQize(),
            e.insertBefore(n.jQ),
            n[Tt] = r.ends[Ct],
            r.finalizeInsert(n.options, n),
            r.ends[Ct][Ct].siblingCreated && r.ends[Ct][Ct].siblingCreated(n.options, Tt),
            r.ends[Tt][Tt].siblingCreated && r.ends[Tt][Tt].siblingCreated(n.options, Ct),
            n.parent.bubble("reflow")),
            this
        }
        ,
        t.renderLatexMath = function(t) {
            var e, n, i = this.root, s = this.cursor, r = w.all, o = w.eof, a = x.skip(o).or(r.result(!1)).parse(t);
            i.eachChild("postOrder", "dispose"),
            i.ends[Tt] = i.ends[Ct] = 0,
            a && a.children().adopt(i, 0, 0),
            e = i.jQ,
            a ? (n = a.join("html"),
            e.html(n),
            i.jQize(e.children()),
            i.finalizeInsert(s.options)) : e.empty(),
            delete s.selection,
            s.insAtRightEnd(i)
        }
        ,
        t.renderLatexText = function(t) {
            var e, n, i, s, r, o, a, l, c, u, h = this.root, f = this.cursor;
            if (h.jQ.children().slice(1).remove(),
            h.eachChild("postOrder", "dispose"),
            h.ends[Tt] = h.ends[Ct] = 0,
            delete f.selection,
            f.show().insAtRightEnd(h),
            e = w.regex,
            n = w.string,
            i = w.eof,
            s = w.all,
            r = n("$").then(x).skip(n("$").or(i)).map(function(t) {
                var e, n = S(f);
            ...
            c = l.skip(i).or(s.result(!1)).parse(t)) {
                ...
                h.jQize().appendTo(h.jQ),
                h.finalizeInsert(f.options)
            }
        }
    }),
    zt.open(function(e) {
        Bt.p.ignoreNextMousedown = t,
        e.delegateMouseEvents = function() {
            ...
            this.container.bind("mousedown.mathquill", function(n) {
                ...
                function r(t) {
                    u.blink = h,
                    u.selection || (c.editable ? u.show() : f.detach()),
                    a.unbind("mousemove", i),
                    _t(t.target.ownerDocument).unbind("mousemove", s).unbind("mouseup", r)
                }
                var o, a = _t(n.target).closest(".mq-root-block"), l = St.byId[a.attr(xt) || e.attr(xt)], c = l.controller, u = c.cursor, h = u.blink, f = c.textareaSpan, p = c.textarea;
                n.preventDefault(),
                n.target.unselectable = !0,
                u.options.ignoreNextMousedown(n) || (u.options.ignoreNextMousedown = t,
                c.blurred && (c.editable || a.prepend(f),
                p.focus()),
                u.blink = t,
                c.seek(_t(n.target), n.pageX, n.pageY).cursor.startSelection(),
                a.mousemove(i),
                _t(n.target.ownerDocument).mousemove(s).mouseup(r))
            })
        }
    }),
    zt.open(function(t) {
        t.seek = function(t, e, n) {
            ...
            return t && (i = t.attr(xt) || t.attr(qt),
            i || (r = t.parent(),
            i = r.attr(xt) || r.attr(qt))),
            o = i ? St.byId[i] : this.root,
    ...
    zt.open(function(t) {
        t.scrollHoriz = function() {
            var t, e, n, i, s, r = this.cursor, o = r.selection, a = this.root.jQ[0].getBoundingClientRect();
            if (o)
                if (n = o.jQ[0].getBoundingClientRect(),
                i = n.left - (a.left + 20),
            ...
            else if (t = r.jQ[0].getBoundingClientRect().left,
            t > a.right - 20)
                e = t - (a.right - 20);
            else {
                if (!(t < a.left + 20))
    ...
    zt.open(function(t) {
        ...
        t.createTextarea = function() {
            var t, e = this.textareaSpan = _t('<span class="mq-textarea"></span>'), n = this.options.substituteTextarea();
            if (!n.nodeType)
                throw "substituteTextarea() must return a DOM element, got " + n;
            n = this.textarea = _t(n).appendTo(e),
            t = this,
        ...
        t.selectionChanged = function() {
            var t = this;
            Y(t.container[0]),
            t.textareaSelectionTimeout === m && (t.textareaSelectionTimeout = setTimeout(function() {
                t.setTextareaSelection()
            }))
        }
        ,
        t.setTextareaSelection = function() {
            ...
            var t = "";
            this.cursor.selection && (t = this.cursor.selection.join("latex"),
        ...
        t.staticMathTextareaEvents = function() {
            ...
            e.cursor)
              , i = e.textarea
              , s = e.textareaSpan;
            this.container.prepend('<span class="mq-selectable">$' + e.exportLatex() + "$</span>"),
            e.blurred = !0,
            i.bind("cut paste", !1).focus(function() {
                e.blurred = !1
            }).blur(function() {
    ...
    y = Qt(St, function(t, e) {
        t.finalizeInsert = function(t, e) {
            ...
            n.postOrder("blur"),
            n.postOrder("reflow"),
            n[Ct].siblingCreated && n[Ct].siblingCreated(t, Tt),
            n[Tt].siblingCreated && n[Tt].siblingCreated(t, Ct),
            n.bubble("reflow")
        }
    }),
    O = Qt(y, function(t, e) {
        ...
        t.createLeftOf = function(t) {
            ...
            i && (i.adopt(n.ends[Tt], 0, 0),
            i.jQ.appendTo(n.ends[Tt].jQ)),
            n.finalizeInsert(t.options),
            n.placeCursor(t)
        }
        ,
        t.createBlocks = function() {
            var t, e, n = this, i = n.numBlocks(), s = n.blocks = Array(i);
            for (t = 0; i > t; t += 1)
                e = s[t] = T(),
                e.adopt(n, n.ends[Ct], 0)
        }
        ,
        ...
        t.seek = function(t, e) {
            function n(t) {
                var e = {};
                return e[Tt] = t.jQ.offset().left,
                e[Ct] = e[Tt] + t.jQ.outerWidth(),
                e
            }
            var i, s = this, r = n(s);
            return t < r[Tt] ? e.insLeftOf(s) : t > r[Ct] ? e.insRightOf(s) : (i = r[Tt],
            void s.eachChild(function(o) {
                var a = n(o);
                return t < a[Tt] ? (t - i < a[Tt] - t ? o[Tt] ? e.insAtRightEnd(o[Tt]) : e.insLeftOf(s) : e.insAtLeftEnd(o),
                !1) : t > a[Ct] ? void (o[Ct] ? i = a[Ct] : r[Ct] - t < t - a[Ct] ? e.insRightOf(s) : e.insAtRightEnd(o)) : (o.seek(t, e),
                !1)
            }))
        }
        ,
        ...
        ,
        t.html = function() {
            var t, e, n, i = this, r = i.blocks, o = " mathquill-command-id=" + i.id, a = i.htmlTemplate.match(/<[^<>]+>|[^<>]+/g);
            for (s("no unmatched angle brackets", a.join("") === this.htmlTemplate),
            t = 0,
            e = a[0]; e; t += 1,
            e = a[t])
                if ("/>" === e.slice(-2))
                    ...
                    s("not an unmatched top-level close tag", "/" !== e.charAt(1)),
                    a[t] = e.slice(0, -1) + o + ">",
                    n = 1;
                    do
                        t += 1,
                        ...
                        "</" === e.slice(0, 2) ? n -= 1 : "<" === e.charAt(0) && "/>" !== e.slice(-2) && (n += 1);
                    while (n > 0)
                }
    ...
    T = Qt(y, function(t, e) {
        ...
        t.keystroke = function(t, n, i) {
            return !i.options.spaceBehavesLikeTab || "Spacebar" !== t && "Shift-Spacebar" !== t ? e.keystroke.apply(this, arguments) : (n.preventDefault(),
            void i.escapeDir("Shift-Spacebar" === t ? Tt : Ct, t, n))
        }
        ,
        ...
        t.seek = function(t, e) {
            ...
            if (t < this.ends[Tt].jQ.offset().left)
    ...
    Mt.StaticMath = function(t) {
        return Qt(t.AbstractMathQuill, function(e, n) {
            this.RootBlock = T,
            e.__mathquillify = function() {
                return n.__mathquillify.call(this, "mq-math-mode"),
                this.__controller.delegateMouseEvents(),
    ...
    _ = Qt(St, function(t, e) {
        function n(t) {
            var e, n;
            return t.jQ[0].normalize(),
            (e = t.jQ[0].firstChild) ? (s("only node in TextBlock span is Text node", 3 === e.nodeType),
            n = D(e.data),
            n.jQadd(e),
            t.children().disown(),
            n.adopt(t, 0, 0)) : void 0
        }
        t.ctrlSeq = "\\text",
        t.replaces = function(t) {
        ...
        t.jQadd = function(t) {
            e.jQadd.call(this, t),
            this.ends[Tt] && this.ends[Tt].jQadd(this.jQ[0].firstChild)
        }
        ,
        t.createLeftOf = function(t) {
            var n, i = this;
            if (e.createLeftOf.call(this, t),
            i[Ct].siblingCreated && i[Ct].siblingCreated(t.options, Tt),
            i[Tt].siblingCreated && i[Tt].siblingCreated(t.options, Ct),
            i.bubble("reflow"),
            t.insAtRightEnd(i),
            i.replacedText)
        ...
        t.parser = function() {
            ...
            return i.then(e("{")).then(n(/^[^}]*/)).skip(e("}")).map(function(e) {
                return 0 === e.length ? Lt() : (D(e).adopt(t, 0, 0),
                t)
            })
        }
        ,
        ...
        t.write = function(t, n) {
            ...
            "$" !== n ? t[Tt] ? t[Tt].appendText(n) : D(n).createLeftOf(t) : this.isEmpty() ? (t.insRightOf(this),
            j("\\$", "$").createLeftOf(t)) : t[Ct] ? t[Tt] ? (i = _(),
            s = this.ends[Tt],
            s.disown().jQ.detach(),
            s.adopt(i, 0, 0),
            t.insLeftOf(this),
            e.createLeftOf.call(i, t)) : t.insLeftOf(this) : t.insRightOf(this)
        }
        ,
        t.seek = function(t, e) {
            var i, s, r, o, a, l, c, u;
            ...
            0 >= r ? e.insAtLeftEnd(this) : r >= i.text.length ? e.insAtRightEnd(this) : e.insLeftOf(i.splitRight(r)),
            ...
            l = a; e[a] && o * l > 0; )
                ...
                l = o,
                o = t - e.offset().left;
            -a * l > a * o && e[-a].moveTowards(-a, e),
            e.anticursor ? e.anticursor.parent === this && (c = e[Tt] && e[Tt].text.length,
            this.anticursorPosition === c ? e.anticursor = Dt.copy(e) : (this.anticursorPosition < c ? (u = e[Tt].splitRight(this.anticursorPosition),
            e[Tt] = u) : u = e[Ct].splitRight(this.anticursorPosition - c),
            e.anticursor = Dt(this, u[Tt], u))) : this.anticursorPosition = e[Tt] && e[Tt].text.length
        }
        ,
        t.blur = function(t) {
            T.prototype.blur.call(this),
            t && ("" === this.textContents() ? (this.remove(),
            t[Tt] === this ? t[Tt] = this[Tt] : t[Ct] === this && (t[Ct] = this[Ct])) : n(this))
        }
        ,
    ...
    D = Qt(St, function(t, e) {
        ...
        t.insTextAtDirEnd = function(t, e) {
            r(e),
            e === Ct ? this.appendText(t) : this.prependText(t)
        }
        ,
        ...
        t.moveTowards = function(t, e) {
            ...
            i = n(-t, this.text),
            s = this[-t],
            s ? s.insTextAtDirEnd(i, t) : D(i).createDir(-t, e),
        ...
        ,
        t.deleteTowards = function(t, e) {
            this.text.length > 1 ? t === Ct ? (this.dom.deleteData(0, 1),
        ...
        t.selectTowards = function(t, e) {
            ...
            i = e.anticursor,
            s = n(-t, this.text),
            i[t] === this ? (o = D(s).createDir(t, e),
            i[t] = o,
            e.insDirOf(t, o)) : (a = this[-t],
            a ? a.insTextAtDirEnd(s, t) : (o = D(s).createDir(-t, e),
            o.jQ.insDirOf(-t, e.selection.jQ)),
            1 === this.text.length && i[-t] === this && (i[-t] = this[-t])),
            this.deleteTowards(t, e)
        }
    }),
    At.$ = Et.text = Et.textnormal = Et.textrm = Et.textup = Et.textmd = _,
    Et.em = Et.italic = Et.italics = Et.emph = Et.textit = Et.textsl = h("\\textit", "i", 'class="mq-text-mode"'),
    Et.strong = Et.bold = Et.textbf = h("\\textbf", "b", 'class="mq-text-mode"'),
    Et.sf = Et.textsf = h("\\textsf", "span", 'class="mq-sans-serif mq-text-mode"'),
    Et.tt = Et.texttt = h("\\texttt", "span", 'class="mq-monospace mq-text-mode"'),
    Et.textsc = h("\\textsc", "span", 'style="font-variant:small-caps" class="mq-text-mode"'),
    Et.uppercase = h("\\uppercase", "span", 'style="text-transform:uppercase" class="mq-text-mode"'),
    Et.lowercase = h("\\lowercase", "span", 'style="text-transform:lowercase" class="mq-text-mode"'),
    S = Qt(O, function(t, e) {
        t.init = function(t) {
            e.init.call(this, "$"),
            this.cursor = t
        ...
        t.createBlocks = function() {
            ...
            this.ends[Tt].cursor = this.cursor,
            this.ends[Tt].write = function(t, e) {
                "$" !== e ? T.prototype.write.call(this, t, e) : this.isEmpty() ? (t.insRightOf(this.parent),
                this.parent.deleteTowards(dir, t),
                j("\\$", "$").createLeftOf(t.show())) : t[Ct] ? t[Tt] ? T.prototype.write.call(this, t, e) : t.insLeftOf(this.parent) : t.insRightOf(this.parent)
            }
        }
        ,
        t.latex = function() {
    ...
    Et["≠"] = Et.ne = Et.neq = i(Q, "\\ne ", "&ne;"),
    Et.ast = Et.star = Et.loast = Et.lowast = i(Q, "\\ast ", "&lowast;"),
    Et.therefor = Et.therefore = i(Q, "\\therefore ", "&there4;"),
    Et.cuz = Et.because = i(Q, "\\because ", "&#8757;"),
    Et.prop = Et.propto = i(Q, "\\propto ", "&prop;"),
    Et["≈"] = Et.asymp = Et.approx = i(Q, "\\approx ", "&asymp;"),
    Et.isin = Et["in"] = i(Q, "\\in ", "&isin;"),
    Et.ni = Et.contains = i(Q, "\\ni ", "&ni;"),
    Et.notni = Et.niton = Et.notcontains = Et.doesnotcontain = i(Q, "\\not\\ni ", "&#8716;"),
    Et.sub = Et.subset = i(Q, "\\subset ", "&sub;"),
    Et.sup = Et.supset = Et.superset = i(Q, "\\supset ", "&sup;"),
    Et.nsub = Et.notsub = Et.nsubset = Et.notsubset = i(Q, "\\not\\subset ", "&#8836;"),
    Et.nsup = Et.notsup = Et.nsupset = Et.notsupset = Et.nsuperset = Et.notsuperset = i(Q, "\\not\\supset ", "&#8837;"),
    Et.sube = Et.subeq = Et.subsete = Et.subseteq = i(Q, "\\subseteq ", "&sube;"),
    Et.supe = Et.supeq = Et.supsete = Et.supseteq = Et.supersete = Et.superseteq = i(Q, "\\supseteq ", "&supe;"),
    Et.nsube = Et.nsubeq = Et.notsube = Et.notsubeq = Et.nsubsete = Et.nsubseteq = Et.notsubsete = Et.notsubseteq = i(Q, "\\not\\subseteq ", "&#8840;"),
    Et.nsupe = Et.nsupeq = Et.notsupe = Et.notsupeq = Et.nsupsete = Et.nsupseteq = Et.notsupsete = Et.notsupseteq = Et.nsupersete = Et.nsuperseteq = Et.notsupersete = Et.notsuperseteq = i(Q, "\\not\\supseteq ", "&#8841;"),
    Et.N = Et.naturals = Et.Naturals = i(j, "\\mathbb{N}", "&#8469;"),
    Et.P = Et.primes = Et.Primes = Et.projective = Et.Projective = Et.probability = Et.Probability = i(j, "\\mathbb{P}", "&#8473;"),
    Et.Z = Et.integers = Et.Integers = i(j, "\\mathbb{Z}", "&#8484;"),
    Et.Q = Et.rationals = Et.Rationals = i(j, "\\mathbb{Q}", "&#8474;"),
    Et.R = Et.reals = Et.Reals = i(j, "\\mathbb{R}", "&#8477;"),
    Et.C = Et.complex = Et.Complex = Et.complexes = Et.Complexes = Et.complexplane = Et.Complexplane = Et.ComplexPlane = i(j, "\\mathbb{C}", "&#8450;"),
    Et.H = Et.Hamiltonian = Et.quaternions = Et.Quaternions = i(j, "\\mathbb{H}", "&#8461;"),
    Et.quad = Et.emsp = i(j, "\\quad ", "    "),
    Et.qquad = i(j, "\\qquad ", "        "),
    Et.diamond = i(j, "\\diamond ", "&#9671;"),
    Et.bigtriangleup = i(j, "\\bigtriangleup ", "&#9651;"),
    Et.ominus = i(j, "\\ominus ", "&#8854;"),
    Et.uplus = i(j, "\\uplus ", "&#8846;"),
    Et.bigtriangledown = i(j, "\\bigtriangledown ", "&#9661;"),
    Et.sqcap = i(j, "\\sqcap ", "&#8851;"),
    Et.triangleleft = i(j, "\\triangleleft ", "&#8882;"),
    Et.sqcup = i(j, "\\sqcup ", "&#8852;"),
    Et.triangleright = i(j, "\\triangleright ", "&#8883;"),
    Et.odot = Et.circledot = i(j, "\\odot ", "&#8857;"),
    Et.bigcirc = i(j, "\\bigcirc ", "&#9711;"),
    Et.dagger = i(j, "\\dagger ", "&#0134;"),
    Et.ddagger = i(j, "\\ddagger ", "&#135;"),
    Et.wr = i(j, "\\wr ", "&#8768;"),
    Et.amalg = i(j, "\\amalg ", "&#8720;"),
    Et.models = i(j, "\\models ", "&#8872;"),
    Et.prec = i(j, "\\prec ", "&#8826;"),
    Et.succ = i(j, "\\succ ", "&#8827;"),
    Et.preceq = i(j, "\\preceq ", "&#8828;"),
    Et.succeq = i(j, "\\succeq ", "&#8829;"),
    Et.simeq = i(j, "\\simeq ", "&#8771;"),
    Et.mid = i(j, "\\mid ", "&#8739;"),
    Et.ll = i(j, "\\ll ", "&#8810;"),
    Et.gg = i(j, "\\gg ", "&#8811;"),
    Et.parallel = i(j, "\\parallel ", "&#8741;"),
    Et.nparallel = i(j, "\\nparallel ", "&#8742;"),
    Et.bowtie = i(j, "\\bowtie ", "&#8904;"),
    Et.sqsubset = i(j, "\\sqsubset ", "&#8847;"),
    Et.sqsupset = i(j, "\\sqsupset ", "&#8848;"),
    Et.smile = i(j, "\\smile ", "&#8995;"),
    Et.sqsubseteq = i(j, "\\sqsubseteq ", "&#8849;"),
    Et.sqsupseteq = i(j, "\\sqsupseteq ", "&#8850;"),
    Et.doteq = i(j, "\\doteq ", "&#8784;"),
    Et.frown = i(j, "\\frown ", "&#8994;"),
    Et.vdash = i(j, "\\vdash ", "&#8870;"),
    Et.dashv = i(j, "\\dashv ", "&#8867;"),
    Et.nless = i(j, "\\nless ", "&#8814;"),
    Et.ngtr = i(j, "\\ngtr ", "&#8815;"),
    Et.longleftarrow = i(j, "\\longleftarrow ", "&#8592;"),
    Et.longrightarrow = i(j, "\\longrightarrow ", "&#8594;"),
    Et.Longleftarrow = i(j, "\\Longleftarrow ", "&#8656;"),
    Et.Longrightarrow = i(j, "\\Longrightarrow ", "&#8658;"),
    Et.longleftrightarrow = i(j, "\\longleftrightarrow ", "&#8596;"),
    Et.updownarrow = i(j, "\\updownarrow ", "&#8597;"),
    Et.Longleftrightarrow = i(j, "\\Longleftrightarrow ", "&#8660;"),
    Et.Updownarrow = i(j, "\\Updownarrow ", "&#8661;"),
    Et.mapsto = i(j, "\\mapsto ", "&#8614;"),
    Et.nearrow = i(j, "\\nearrow ", "&#8599;"),
    Et.hookleftarrow = i(j, "\\hookleftarrow ", "&#8617;"),
    Et.hookrightarrow = i(j, "\\hookrightarrow ", "&#8618;"),
    Et.searrow = i(j, "\\searrow ", "&#8600;"),
    Et.leftharpoonup = i(j, "\\leftharpoonup ", "&#8636;"),
    Et.rightharpoonup = i(j, "\\rightharpoonup ", "&#8640;"),
    Et.swarrow = i(j, "\\swarrow ", "&#8601;"),
    Et.leftharpoondown = i(j, "\\leftharpoondown ", "&#8637;"),
    Et.rightharpoondown = i(j, "\\rightharpoondown ", "&#8641;"),
    Et.nwarrow = i(j, "\\nwarrow ", "&#8598;"),
    Et.ldots = i(j, "\\ldots ", "&#8230;"),
    Et.cdots = i(j, "\\cdots ", "&#8943;"),
    Et.vdots = i(j, "\\vdots ", "&#8942;"),
    ...
    Et.wp = i(j, "\\wp ", "&#8472;"),
    Et.bot = i(j, "\\bot ", "&#8869;"),
    Et.clubsuit = i(j, "\\clubsuit ", "&#9827;"),
    Et.diamondsuit = i(j, "\\diamondsuit ", "&#9826;"),
    Et.heartsuit = i(j, "\\heartsuit ", "&#9825;"),
    Et.spadesuit = i(j, "\\spadesuit ", "&#9824;"),
    Et.parallelogram = i(j, "\\parallelogram ", "&#9649;"),
    Et.square = i(j, "\\square ", "&#11036;"),
    Et.oint = i(j, "\\oint ", "&#8750;"),
    Et.bigcap = i(j, "\\bigcap ", "&#8745;"),
    Et.bigcup = i(j, "\\bigcup ", "&#8746;"),
    Et.bigsqcup = i(j, "\\bigsqcup ", "&#8852;"),
    Et.bigvee = i(j, "\\bigvee ", "&#8744;"),
    Et.bigwedge = i(j, "\\bigwedge ", "&#8743;"),
    Et.bigodot = i(j, "\\bigodot ", "&#8857;"),
    Et.bigotimes = i(j, "\\bigotimes ", "&#8855;"),
    Et.bigoplus = i(j, "\\bigoplus ", "&#8853;"),
    Et.biguplus = i(j, "\\biguplus ", "&#8846;"),
    Et.lfloor = i(j, "\\lfloor ", "&#8970;"),
    Et.rfloor = i(j, "\\rfloor ", "&#8971;"),
    Et.lceil = i(j, "\\lceil ", "&#8968;"),
    Et.rceil = i(j, "\\rceil ", "&#8969;"),
    Et.opencurlybrace = Et.lbrace = i(j, "\\lbrace ", "{"),
    Et.closecurlybrace = Et.rbrace = i(j, "\\rbrace ", "}"),
    Et.lbrack = i(j, "["),
    Et.rbrack = i(j, "]"),
    Et.slash = i(j, "/"),
    Et.vert = i(j, "|"),
    Et.perp = Et.perpendicular = i(j, "\\perp ", "&perp;"),
    Et.nabla = Et.del = i(j, "\\nabla ", "&nabla;"),
    Et.hbar = i(j, "\\hbar ", "&#8463;"),
    Et.AA = Et.Angstrom = Et.angstrom = i(j, "\\text\\AA ", "&#8491;"),
    Et.ring = Et.circ = Et.circle = i(j, "\\circ ", "&#8728;"),
    Et.bull = Et.bullet = i(j, "\\bullet ", "&bull;"),
    Et.setminus = Et.smallsetminus = i(j, "\\setminus ", "&#8726;"),
    Et.not = Et["¬"] = Et.neg = i(j, "\\neg ", "&not;"),
    Et["…"] = Et.dots = Et.ellip = Et.hellip = Et.ellipsis = Et.hellipsis = i(j, "\\dots ", "&hellip;"),
    Et.converges = Et.darr = Et.dnarr = Et.dnarrow = Et.downarrow = i(j, "\\downarrow ", "&darr;"),
    Et.dArr = Et.dnArr = Et.dnArrow = Et.Downarrow = i(j, "\\Downarrow ", "&dArr;"),
    Et.diverges = Et.uarr = Et.uparrow = i(j, "\\uparrow ", "&uarr;"),
    Et.uArr = Et.Uparrow = i(j, "\\Uparrow ", "&uArr;"),
    Et.to = i(Q, "\\to ", "&rarr;"),
    Et.rarr = Et.rightarrow = i(j, "\\rightarrow ", "&rarr;"),
    Et.implies = i(Q, "\\Rightarrow ", "&rArr;"),
    Et.rArr = Et.Rightarrow = i(j, "\\Rightarrow ", "&rArr;"),
    Et.gets = i(Q, "\\gets ", "&larr;"),
    Et.larr = Et.leftarrow = i(j, "\\leftarrow ", "&larr;"),
    Et.impliedby = i(Q, "\\Leftarrow ", "&lArr;"),
    Et.lArr = Et.Leftarrow = i(j, "\\Leftarrow ", "&lArr;"),
    Et.harr = Et.lrarr = Et.leftrightarrow = i(j, "\\leftrightarrow ", "&harr;"),
    Et.iff = i(Q, "\\Leftrightarrow ", "&hArr;"),
    Et.hArr = Et.lrArr = Et.Leftrightarrow = i(j, "\\Leftrightarrow ", "&hArr;"),
    Et.Re = Et.Real = Et.real = i(j, "\\Re ", "&real;"),
    Et.Im = Et.imag = Et.image = Et.imagin = Et.imaginary = Et.Imaginary = i(j, "\\Im ", "&image;"),
    Et.part = Et.partial = i(j, "\\partial ", "&part;"),
    Et.infty = Et.infin = Et.infinity = i(j, "\\infty ", "&infin;"),
    Et.alef = Et.alefsym = Et.aleph = Et.alephsym = i(j, "\\aleph ", "&alefsym;"),
    Et.xist = Et.xists = Et.exist = Et.exists = i(j, "\\exists ", "&exist;"),
    Et.nexists = Et.nexist = i(j, "\\nexists ", "&#8708;"),
    Et.and = Et.land = Et.wedge = i(j, "\\wedge ", "&and;"),
    Et.or = Et.lor = Et.vee = i(j, "\\vee ", "&or;"),
    Et.o = Et.O = Et.empty = Et.emptyset = Et.oslash = Et.Oslash = Et.nothing = Et.varnothing = i(Q, "\\varnothing ", "&empty;"),
    Et.cup = Et.union = i(Q, "\\cup ", "&cup;"),
    Et.cap = Et.intersect = Et.intersection = i(Q, "\\cap ", "&cap;"),
    Et.deg = Et.degree = i(j, "\\degree ", "&deg;"),
    Et.ang = Et.angle = i(j, "\\angle ", "&ang;"),
    Et.measuredangle = i(j, "\\measuredangle ", "&#8737;"),
    E = Qt(j, function(t, e) {
        t.createLeftOf = function(t) {
            t.options.autoSubscriptNumerals && t.parent !== t.parent.parent.sub && (t[Tt]instanceof A && t[Tt].isItalic !== !1 || t[Tt]instanceof st && t[Tt][Tt]instanceof A && t[Tt][Tt].isItalic !== !1) ? (Et._().createLeftOf(t),
    ...
    A = Qt(k, function(t, e) {
        ...
        t.text = function() {
            var t = this.ctrlSeq;
            return !this[Tt] || this[Tt]instanceof A || this[Tt]instanceof Q || "\\ " === this[Tt].ctrlSeq || (t = "*" + t),
            !this[Ct] || this[Ct]instanceof Q || this[Ct]instanceof st || (t += "*"),
            t
        }
    }),
    Bt.p.autoCommands = {
    ...
    Ft.autoCommands = function(t) {
        ...
        s = 0; s < e.length; s += 1) {
            ...
            if (Et[r] === B)
                throw '"' + r + '" is a built-in operator name';
            n[r] = 1,
            i = Ot(i, r.length)
        }
    ...
    R = Qt(A, function(t, e) {
        ...
        t.createLeftOf = function(t) {
            var n, i, s, r, o;
            if (e.createLeftOf.apply(this, arguments),
            n = t.options.autoCommands,
            i = n._maxLength,
            i > 0) {
                for (s = "",
                r = this,
                o = 0; r instanceof R && r.ctrlSeq === r.letter && i > o; )
                    s = r.letter + s,
                    r = r[Tt],
                    o += 1;
                for (; s.length; ) {
                    if (n.hasOwnProperty(s)) {
                        for (o = 1,
                        r = this; o < s.length; o += 1,
                        r = r[Tt])
                            ;
                        return Lt(r, this).remove(),
                        t[Tt] = r[Tt],
                        Et[s](s).createLeftOf(t)
                    }
                    s = s.slice(1)
                }
            }
        ...
        t.autoUnItalicize = function(t) {
            ...
            if (0 !== m._maxLength) {
                for (e = this.letter,
                i = this[Tt]; i instanceof R; i = i[Tt])
                    e = i.letter + e;
                ...
                t: for (r = 0,
                o = i[Ct] || this.parent.ends[Tt]; r < e.length; r += 1,
                o = o[Ct])
                    for (a = yt(m._maxLength, e.length - r); a > 0; a -= 1)
                        ...
                        m.hasOwnProperty(l)) {
                            ...
                            u = u[Ct])
                                u.italicize(!1),
                                h = u;
                            f = I.hasOwnProperty(l),
                            o.ctrlSeq = (f ? "\\" : "\\operatorname{") + o.ctrlSeq,
                            h.ctrlSeq += f ? " " : "}",
                            M.hasOwnProperty(l) && h[Tt][Tt][Tt].jQ.addClass("mq-last"),
                            n(o[Tt]) || o.jQ.addClass("mq-first"),
                            n(h[Ct]) || (h[Ct]instanceof st ? (p = h[Ct],
                            (d = p.siblingCreated = p.siblingDeleted = function() {
                                p.jQ.toggleClass("mq-after-operator-name", !(p[Ct]instanceof ht))
                            }
                            )()) : h.jQ.toggleClass("mq-last", !(h[Ct]instanceof ht))),
                            r += a - 1,
                            o = h;
                            continue t
                        }
    ...
    function() {
        ...
        for (t = 0; t < s.length; t += 1)
            I[s[t]] = z[s[t]] = 1;
        for (e = "sin cos tan arcsin arccos arctan sinh cosh tanh sec csc cot coth".split(" "),
        t = 0; t < e.length; t += 1)
            I[e[t]] = 1;
        for (n = "sin cos tan sec cosec csc cotan cot ctg".split(" "),
        t = 0; t < n.length; t += 1)
            z[n[t]] = z["arc" + n[t]] = z[n[t] + "h"] = z["ar" + n[t] + "h"] = z["arc" + n[t] + "h"] = 1;
        for (i = "gcf hcf lcm proj span".split(" "),
        t = 0; t < i.length; t += 1)
            z[i[t]] = 1
    }(),
    ...
    Et.f = Qt(R, function(t, e) {
        ...
        ,
        t.italicize = function(t) {
            return this.jQ.html("f").toggleClass("mq-f", t),
            e.italicize.apply(this, arguments)
        }
    }),
    Et[" "] = Et.space = i(j, "\\ ", "&nbsp;"),
    Et["'"] = Et.prime = i(j, "'", "&prime;"),
    Et.backslash = i(j, "\\backslash ", "\\"),
    At["\\"] || (At["\\"] = Et.backslash),
    Et.$ = i(j, "\\$", "$"),
    $ = Qt(k, function(t, e) {
        t.init = function(t, n) {
    ...
    Et["&"] = i($, "\\&", "&amp;"),
    Et["%"] = i($, "\\%", "%"),
    Et.alpha = Et.beta = Et.gamma = Et.delta = Et.zeta = Et.eta = Et.theta = Et.iota = Et.kappa = Et.mu = Et.nu = Et.xi = Et.rho = Et.sigma = Et.tau = Et.chi = Et.psi = Et.omega = Qt(A, function(t, e) {
        t.init = function(t) {
            e.init.call(this, "\\" + t + " ", "&" + t + ";")
        }
    }),
    Et.phi = i(A, "\\phi ", "&#981;"),
    Et.phiv = Et.varphi = i(A, "\\varphi ", "&phi;"),
    Et.epsilon = i(A, "\\epsilon ", "&#1013;"),
    Et.epsiv = Et.varepsilon = i(A, "\\varepsilon ", "&epsilon;"),
    Et.piv = Et.varpi = i(A, "\\varpi ", "&piv;"),
    Et.sigmaf = Et.sigmav = Et.varsigma = i(A, "\\varsigma ", "&sigmaf;"),
    Et.thetav = Et.vartheta = Et.thetasym = i(A, "\\vartheta ", "&thetasym;"),
    Et.upsilon = Et.upsi = i(A, "\\upsilon ", "&upsilon;"),
    Et.gammad = Et.Gammad = Et.digamma = i(A, "\\digamma ", "&#989;"),
    Et.kappav = Et.varkappa = i(A, "\\varkappa ", "&#1008;"),
    Et.rhov = Et.varrho = i(A, "\\varrho ", "&#1009;"),
    Et.pi = Et["π"] = i($, "\\pi ", "&pi;"),
    Et.lambda = i($, "\\lambda ", "&lambda;"),
    Et.Upsilon = Et.Upsi = Et.upsih = Et.Upsih = i(k, "\\Upsilon ", '<var style="font-family: serif">&upsih;</var>'),
    Et.Gamma = Et.Delta = Et.Theta = Et.Lambda = Et.Xi = Et.Pi = Et.Sigma = Et.Phi = Et.Psi = Et.Omega = Et.forall = Qt(j, function(t, e) {
        t.init = function(t) {
            e.init.call(this, "\\" + t + " ", "&" + t + ";")
        }
    }),
    N = Qt(O, function(t) {
        ...
        t.createLeftOf = function(t) {
            ...
            e.children().adopt(t.parent, t[Tt], t[Ct]),
            t[Tt] = e.ends[Ct],
            e.jQize().insertBefore(t.jQ),
            e.finalizeInsert(t.options, t),
            e.ends[Ct][Ct].siblingCreated && e.ends[Ct][Ct].siblingCreated(t.options, Tt),
            e.ends[Tt][Tt].siblingCreated && e.ends[Tt][Tt].siblingCreated(t.options, Ct),
    ...
    Et["¾"] = i(N, "\\frac34"),
    P = Qt(Q, function(t) {
        t.init = j.prototype.init,
        t.contactWeld = t.siblingCreated = t.siblingDeleted = function(t, e) {
            return e !== Ct ? (this.jQ[0].className = !this[Tt] || this[Tt]instanceof Q || /^[,;:\(\[]$/.test(this[Tt].ctrlSeq) ? "" : "mq-binary-operator",
            this) : void 0
        }
    }),
    Et["+"] = i(P, "+", "+"),
    Et["–"] = Et["-"] = i(P, "-", "&minus;"),
    Et["±"] = Et.pm = Et.plusmn = Et.plusminus = i(P, "\\pm ", "&plusmn;"),
    Et.mp = Et.mnplus = Et.minusplus = i(P, "\\mp ", "&#8723;"),
    At["*"] = Et.sdot = Et.cdot = i(Q, "\\cdot ", "&middot;", "*"),
    U = Qt(Q, function(t, e) {
        t.init = function(t, n) {
            this.data = t,
            this.strict = n;
        ...
        t.deleteTowards = function(t, n) {
            return t !== Tt || this.strict ? void e.deleteTowards.apply(this, arguments) : (this.swap(!0),
    ...
    Et["<"] = Et.lt = i(U, W, !0),
    Et[">"] = Et.gt = i(U, H, !0),
    Et["≤"] = Et.le = Et.leq = i(U, W, !1),
    Et["≥"] = Et.ge = Et.geq = i(U, H, !1),
    G = Qt(Q, function(t, e) {
        t.init = function() {
            e.init.call(this, "=", "=")
        }
        ,
        t.createLeftOf = function(t) {
            return t[Tt]instanceof U && t[Tt].strict ? (t[Tt].swap(!1),
            void t[Tt].bubble("reflow")) : void e.createLeftOf.apply(this, arguments)
        }
    }),
    Et["="] = G,
    Et["×"] = Et.times = i(Q, "\\times ", "&times;", "[x]"),
    Et["÷"] = Et.div = Et.divide = Et.divides = i(Q, "\\div ", "&divide;", "[/]"),
    At["~"] = Et.sim = i(Q, "\\sim ", "~", "~"),
    Y = t,
    ...
    K = function(t, e, n) {
        ...
        s = t.children().css("filter", "progid:DXImageTransform.Microsoft.Matrix(M11=" + e + ",SizingMethod='auto expand')"),
        i(),
        r = setInterval(i),
        _t(window).load(function() {
            clearTimeout(r),
            i()
        })
    }
    ...
    Et.mathrm = i(et, "\\mathrm", "span", 'class="mq-roman mq-font"'),
    Et.mathit = i(et, "\\mathit", "i", 'class="mq-font"'),
    Et.mathbf = i(et, "\\mathbf", "b", 'class="mq-font"'),
    Et.mathsf = i(et, "\\mathsf", "span", 'class="mq-sans-serif mq-font"'),
    Et.mathtt = i(et, "\\mathtt", "span", 'class="mq-monospace mq-font"'),
    Et.underline = i(et, "\\underline", "span", 'class="mq-non-leaf mq-underline"'),
    Et.overline = Et.bar = i(et, "\\overline", "span", 'class="mq-non-leaf mq-overline"'),
    Et.overrightarrow = i(et, "\\overrightarrow", "span", 'class="mq-non-leaf mq-overarrow mq-arrow-right"'),
    Et.overleftarrow = i(et, "\\overleftarrow", "span", 'class="mq-non-leaf mq-overarrow mq-arrow-left"'),
    nt = Et.textcolor = Qt(O, function(t, e) {
    ...
    it = Et["class"] = Qt(O, function(t, e) {
        t.parser = function() {
            ...
            return w.optWhitespace.then(n("{")).then(i(/^[-\w\s\\\xA0-\xFF]*/)).skip(n("}")).then(function(n) {
                return t.htmlTemplate = '<span class="mq-class ' + n + '">&0</span>',
                e.parser.call(t)
            })
        }
    }),
    st = Qt(O, function(t, e) {
            ...
            for (e = Tt; e; e = e === Tt ? Ct : !1)
                if (this[e]instanceof st) {
                    for (n = "sub"; n; n = "sub" === n ? "sup" : !1)
                        i = this[n],
                        s = this[e][n],
                        i && (s ? i.isEmpty() ? o = Dt(s, 0, s.ends[Tt]) : (i.jQ.children().insAtDirEnd(-e, s.jQ),
                        r = i.children().disown(),
                        o = Dt(s, r.ends[Ct], s.ends[Tt]),
                        e === Tt ? r.adopt(s, s.ends[Ct], 0) : r.adopt(s, 0, s.ends[Tt])) : this[e].addBlock(i.disown()),
                    ...
                    this.remove(),
                    t && t[Tt] === this && (e === Ct && o ? o[Tt] ? t.insRightOf(o[Tt]) : t.insAtLeftEnd(o.parent) : t.insRightOf(this[e]));
                    break
                }
        }
        ,
        Bt.p.charsThatBreakOutOfSupSub = "",
            ...
            this.ends[Tt].write = function(t, e) {
                if (t.options.autoSubscriptNumerals && this === this.parent.sub) {
                    if ("_" === e)
                        return;
                    var n = this.chToCmd(e);
                    return n instanceof k ? t.deleteSelection() : t.clearSelection().insRightOf(this.parent),
                    n.createLeftOf(t.show())
                }
                t[Tt] && !t[Ct] && !t.selection && t.options.charsThatBreakOutOfSupSub.indexOf(e) > -1 && t.insRightOf(this.parent),
                T.p.write.apply(this, arguments)
            }
        }
        ,
        ...
        t.deleteTowards = function(t, n) {
            if (n.options.autoSubscriptNumerals && this.sub) {
                ...
                i instanceof k ? i.remove() : i && i.deleteTowards(t, n.insAtDirEnd(-t, this.sub)),
                this.sub.isEmpty() && (this.sub.deleteOutOf(Tt, n.insAtLeftEnd(this.sub)),
        ...
        t.addBlock = function(t) {
            ...
            t.jQ = _t('<span class="mq-sup"/>').append(t.jQ.children()).attr(xt, t.id).prependTo(this.jQ)) : (this.sub = this.downInto = this.sup.downOutOf = t,
            t.adopt(this, 0, this.sup).upOutOf = this.sup,
            t.jQ = _t('<span class="mq-sub"></span>').append(t.jQ.children()).attr(xt, t.id).appendTo(this.jQ.removeClass("mq-sup-only")),
            this.jQ.append('<span style="display:inline-block;width:0">&#8203;</span>'));
            for (var e = 0; 2 > e; e += 1)
                (function(t, e, n, i) {
                    t[e].deleteOutOf = function(s, r) {
                        if (r.insDirOf(this[s] ? -s : s, this.parent),
                        !this.isEmpty()) {
                            var o = this.ends[s];
                            this.children().disown().withDirAdopt(s, r.parent, r[s], r[-s]).jQ.insDirOf(-s, r.jQ),
                            r[-s] = o
                        }
                        t.supsub = n,
                        delete t[e],
                        ...
                        "sub" === e && _t(t.jQ.addClass("mq-sup-only")[0].lastChild).remove(),
                        this.remove()
                    }
                }
    ...
    Et.subscript = Et._ = Qt(st, function(t, e) {
        ...
        t.textTemplate = ["_"],
        t.finalizeTree = function() {
            this.downInto = this.sub = this.ends[Tt],
            this.sub.upOutOf = f,
    ...
    Et.superscript = Et.supscript = Et["^"] = Qt(st, function(t, e) {
        ...
        t.textTemplate = ["^"],
        t.finalizeTree = function() {
            this.upInto = this.sup = this.ends[Ct],
    ...
    rt = Qt(O, function(t, e) {
        ...
        t.createLeftOf = function(t) {
            ...
            t.options.sumStartsWithNEquals && (R("n").createLeftOf(t),
            G().createLeftOf(t))
        }
        ,
        t.latex = function() {
        ...
        ,
        t.parser = function() {
            var t, e = w.string, n = w.optWhitespace, i = w.succeed, s = x.block, r = this, o = r.blocks = [T(), T()];
            for (t = 0; t < o.length; t += 1)
                o[t].adopt(r, r.ends[Ct], 0);
            return n.then(e("_").or(e("^"))).then(function(t) {
                var e = o["_" === t ? 0 : 1];
                return s.then(function(t) {
                    return t.children().adopt(e, e.ends[Ct], 0),
                    i(r)
                })
            }).many().result(r)
        }
        ...
        t.finalizeTree = function() {
            ...
            this.upInto = this.ends[Ct],
            this.ends[Tt].upOutOf = this.ends[Ct],
            this.ends[Ct].downOutOf = this.ends[Tt]
        }
    }),
    Et["∑"] = Et.sum = Et.summation = i(rt, "\\sum ", "&sum;"),
    Et["∏"] = Et.prod = Et.product = i(rt, "\\prod ", "&prod;"),
    Et.coprod = Et.coproduct = i(rt, "\\coprod ", "&#8720;"),
    Et["∫"] = Et["int"] = Et.integral = Qt(rt, function(t, e) {
        t.init = function() {
    ...
    ot = Et.frac = Et.dfrac = Et.cfrac = Et.fraction = Qt(O, function(t, e) {
        ...
        t.textTemplate = ["(", ")/(", ")"],
        t.finalizeTree = function() {
            this.upInto = this.ends[Ct].upOutOf = this.ends[Tt],
            this.downInto = this.ends[Tt].downOutOf = this.ends[Ct]
        }
    }),
        ...
        e.createLeftOf = function(e) {
            if (!this.replacedFragment) {
                for (var i = e[Tt]; i && !(i instanceof Q || i instanceof (Et.text || t) || i instanceof rt || "\\ " === i.ctrlSeq || /^[,;:]$/.test(i.ctrlSeq)); )
                    i = i[Tt];
                i instanceof rt && i[Ct]instanceof st && (i = i[Ct],
                i[Ct]instanceof st && i[Ct].ctrlSeq != i.ctrlSeq && (i = i[Ct])),
                i !== e[Tt] && (this.replaces(Lt(i[Ct] || e.parent.ends[Tt], e[Tt])),
                e[Tt] = i)
            }
    ...
    ct = Et.vec = Qt(O, function(t, e) {
        t.ctrlSeq = "\\vec",
        t.htmlTemplate = '<span class="mq-non-leaf"><span class="mq-vector-prefix">&rarr;</span><span class="mq-vector-stem">&0</span></span>',
        t.textTemplate = ["vec(", ")"]
    }),
    ...
    ht = Qt(Qt(O, p), function(e, n) {
        ...
        ,
        e.html = function() {
            return this.htmlTemplate = '<span class="mq-non-leaf"><span class="mq-scaled mq-paren' + (this.side === Ct ? " mq-ghost" : "") + '">' + this.sides[Tt].ch + '</span><span class="mq-non-leaf">&0</span><span class="mq-scaled mq-paren' + (this.side === Tt ? " mq-ghost" : "") + '">' + this.sides[Ct].ch + "</span></span>",
            n.html.call(this)
        }
        ,
        e.latex = function() {
        ...
        e.closeOpposing = function(t) {
            ...
            t.delimjQs.eq(this.side === Tt ? 0 : 1).removeClass("mq-ghost").html(this.sides[this.side].ch)
        }
        ,
        e.createLeftOf = function(t) {
            var e, i, s;
            this.replacedFragment || (e = t.options,
            i = this.oppBrack(e, t[Tt], Tt) || this.oppBrack(e, t[Ct], Ct) || this.oppBrack(e, t.parent.parent)),
            i ? (s = this.side = -i.side,
            this.closeOpposing(i),
            i === t.parent.parent && t[s] && (Lt(t[s], t.parent.ends[s], -s).disown().withDirAdopt(-s, i.parent, i, i[s]).jQ.insDirOf(s, i.jQ),
            i.bubble("reflow"))) : (i = this,
            s = i.side,
            i.replacedFragment ? i.side = 0 : t[-s] && (i.replaces(Lt(t[-s], t.parent.ends[-s], s)),
            t[-s] = 0),
            n.createLeftOf.call(i, t)),
            s === Tt ? t.insAtLeftEnd(i.ends[Tt]) : t.insRightOf(i)
        }
        ,
        e.placeCursor = t,
        e.unwrap = function() {
            this.ends[Tt].children().disown().adopt(this.parent, this, this[Ct]).jQ.insertAfter(this.jQ),
            this.remove()
        }
        ,
        e.deleteSide = function(t, e, n) {
            var i, s, r, o = this.parent, a = this[t], l = o.ends[t];
            if (t === this.side)
                return this.unwrap(),
            ...
            s = !this.side,
            this.side = -t,
            this.oppBrack(i, this.ends[Tt].ends[this.side], t))
                this.closeOpposing(this.ends[Tt].ends[this.side]),
                r = this.ends[Tt].ends[t],
                this.unwrap(),
                r.siblingCreated && r.siblingCreated(n.options, t),
                a ? n.insDirOf(-t, a) : n.insAtDirEnd(t, o);
            else {
                if (this.oppBrack(i, this.parent.parent, t))
                ...
                a ? (r = this.ends[Tt].ends[t],
                Lt(a, l, -t).disown().withDirAdopt(-t, this.ends[Tt], r, 0).jQ.insAtDirEnd(t, this.ends[Tt].jQ.removeClass("mq-empty")),
                r.siblingCreated && r.siblingCreated(n.options, t),
                n.insDirOf(-t, a)) : e ? n.insDirOf(t, this) : n.insAtDirEnd(t, this.ends[Tt])
            }
        }
        ,
        e.deleteTowards = function(t, e) {
        ...
        e.finalizeTree = function() {
            ...
            this.finalizeTree = this.intentionalBlur = function() {
                this.delimjQs.eq(this.side === Tt ? 1 : 0).removeClass("mq-ghost"),
                this.side = 0
            }
        }
        ,
    ...
    d("["),
    d("{", "\\{"),
    Et.langle = i(ht, Tt, "&lang;", "&rang;", "\\langle ", "\\rangle "),
    Et.rangle = i(ht, Ct, "&lang;", "&rang;", "\\langle ", "\\rangle "),
    At["|"] = i(ht, Tt, "|", "|", "|", "|"),
    Et.left = Qt(O, function(t) {
        t.parser = function() {
            var t = w.regex
              , e = w.string
              , n = (w.succeed,
    ...
    mt = Et.embed = Qt(k, function(t, e) {
        ...
        t.parser = function() {
            ...
            regex = w.regex,
            succeed = w.succeed,
            string("{").then(regex(/^[a-z][a-z0-9]*/i)).skip(string("}")).then(function(e) {
    ...
    gt = At["\\"] = Qt(O, function(t, e) {
        ...
        t.createBlocks = function() {
            ...
            this.ends[Tt].write = function(t, e) {
                t.show().deleteSelection(),
                e.match(/[a-z]/i) ? j(e).createLeftOf(t) : (this.parent.renderCommand(t),
                "\\" === e && this.isEmpty() || this.parent.parent.write(t, e))
            }
            ,
            this.ends[Tt].keystroke = function(t, n, i) {
                return "Tab" === t || "Enter" === t || "Spacebar" === t ? (this.parent.renderCommand(i.cursor),
        ...
        t.createLeftOf = function(t) {
            ...
            this._replacedFragment) {
                ...
                this.jQ = this._replacedFragment.jQ.addClass("mq-blur").bind("mousedown mousemove", function(t) {
                    return _t(t.target = n).trigger(t),
                    !1
        ...
        t.renderCommand = function(t) {
            ...
            this.remove(),
            this[Ct] ? t.insLeftOf(this[Ct]) : t.insAtRightEnd(this.parent),
            e = this.ends[Tt].latex(),
            e || (e = " "),
            n = Et[e],
            n ? (n = n(e),
            this._replacedFragment && n.replaces(this._replacedFragment),
            n.createLeftOf(t)) : (n = _(),
            n.replaces(e),
            n.createLeftOf(t),
            t.insRightOf(n),
